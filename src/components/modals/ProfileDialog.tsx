...
export const ProfileDialog: React.FC<ProfileDialogProps> = ({
  ...
  const handleRegisterSeller = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSellerFormSuccess('Đăng ký hồ sơ Người Bán thành công! Hồ sơ đang chờ Quản trị viên kiểm duyệt.');
      setTimeout(() => setSellerFormSuccess(null), 5000);
    } catch (err: any) {
      setSellerFormError(err.message || 'Gửi hồ sơ đăng ký không thành công.');
    }
  };
